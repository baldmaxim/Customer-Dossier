...
Обновлено: 2026-09-15 (+02:00). Текущий этап: **07**. Статус: **PASS** (прогон пользователя, evidence/07/USER_RUN.md); следующий — 08A. LIVE_SOURCE=NOT_RUN. LOCAL_MODEL (синтетика, qwen3-8b): safety 24/25, recall 3/9 — переразбор рабочей базы на extract@3 не начинать.
...
`stages/STAGE_08A_DOSSIER_UI.md`. Отдельно: разобрать нарушение safety и промахи полноты по `benchmark-06.json` (у пользователя).
