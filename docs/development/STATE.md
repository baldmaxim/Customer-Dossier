...
Обновлено: 2026-09-21. Текущий пакет: **`prompts/TG_Info_Next_Stages_2026-09-16/` (этапы 10–19)**, указание пользователя 2026-09-16 — пройти 10→19 подряд, коммит после каждого этапа; пользовательские проверки копятся в `evidence/NN/USER_RUN.md`.
