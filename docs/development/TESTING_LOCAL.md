...
Ожидается: typecheck без ошибок; unit — **26 файлов / 386 тестов passed**; сборка frontend успешна.
...
(после прогона этапа 06 исправлен дефект «ё» и две потери полноты в проверке; unit — 26 файлов / 386):
