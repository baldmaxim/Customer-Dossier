...
**Сейчас проверяется этап 08B** (схема связей, снимки досье, выгрузки): шаги A1–A5, затем раздел M (данные — из L1).
Разделы B–L — проверки этапов 01–08A (пройдены), повторять не обязательно.
...
Ожидается: `[integration] тестовая цель: 127.0.0.1:55433/tg_info_test`, затем **17 файлов / 182 теста passed**:
