...
| AC-19 | 13,17 | `release.int` «старый снимок цел», `snapshot.int`; `brief.test` «снимок до @3»; B2 проба старого снимка | W | D | B1, B2 | B1r2 **PASS** на `09f0c93` (отпечаток `900d55a5…`, 18.09): 19/19 файлов, 239/239, 0 skipped; B2 (апгрейд со снимком) — NOT_RUN |
