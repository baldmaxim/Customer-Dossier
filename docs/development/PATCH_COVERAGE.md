...
| R08, R09 | partial (06) | неизвестная дата события — NULL в новых проекциях, суд — стадии и роли сторон без вывода вины, план/слух/отрицание не становятся событием карточки; метрики 007 и светофор не менялись — 07 | `semantic.int.test.ts` |
