...
/**
 * Версия правил нормализации. Поднимается при любой правке, меняющей norm/latin/key:
 * строки с другой версией пересчитывает версионный backfill (resolve/renormalize.ts).
 */
